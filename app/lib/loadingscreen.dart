    ...
    try {
      ...
      if (await cloudAttendance.updateUserDataOnCloud()) {
        ...
        Navigator.of(context).pushReplacement(MaterialPageRoute(
            builder: (BuildContext context) => HazirHome(
                  cachedId: widget.userId,
      ...
      body: Container(
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Container(
                  height: _height * 0.45, child: FlareActor("assets/animation.flr", alignment: Alignment.center, fit: BoxFit.fitHeight, animation: "coding")),
              SizedBox(
                height: 60,
              ),
              Text(
                'Hello,',
                style: TextStyle(fontSize: 37, fontWeight: FontWeight.normal),
              ),
              Text(
              ...
              Text(
                'We are collecting your data from Habib\'s server please be patient. This step is only for the first time.',
